...
Один из самых крупных - https://electronjs.org/. На котором сделана в том числе Visual Studio Code (которую я рекомендую тоже поставить, но можете пользоваться и другими IDE).
...
4. Visual Studio Code или если у вас есть какая-то любимая IDE.
...
Мы говорим, что запрос выполнился с кодом 200, т.е. успешно. (https://en.wikipedia.org/wiki/List_of_HTTP_status_codes - другие варианты)
